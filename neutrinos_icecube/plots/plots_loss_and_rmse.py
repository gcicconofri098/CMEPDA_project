...
def loss_plots(train_losses, test_losses, train_rmses, test_rmses):
    ...
    plt.legend()
    plt.show()
    plt.savefig("/gpfs/ddn/cms/user/cicco/miniconda3/CMEPDA/neutrinos_icecube/plots/test_graph_mean_180_epochs_w_early_stop_20_hits_5_DNN_loss_40_0_001_loss_MSE_batch_512_dropout_simpler_mlp_knn_7_2files.png")
    plt.close()
    ...
    plt.legend()
    plt.show()
    plt.savefig("/gpfs/ddn/cms/user/cicco/miniconda3/CMEPDA/neutrinos_icecube/plots/test_graph_mean_180_epochs_w_early_stop_20_hits_5_DNN_RMSE_40_0_001_loss_MSE_batch_512_dropout_simpler_mlp_knn_7_2files.png")
    plt.close()
